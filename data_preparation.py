...
def prepare_data(csv_file, lookback, forecast, debug=False, univariate=True):
    # Load CSV
    ...
    if univariate:
        ...
        X_raw = df[feature_col].values.reshape(-1, 1)  # Ensure shape is (rows, 1)
...
def extract_dates(csv_file, lookback, forecast):
    """
