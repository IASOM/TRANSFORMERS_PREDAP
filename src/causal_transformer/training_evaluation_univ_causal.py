...
def train_given_causal_model_and_data(model, X, Y, batch_size=1024, model_name=None, epochs=100, 
    ...
    if save_model and epochs > 1:  # save model
        ...
        model.encoder_decoder_model.save(default_config.model_folder +"/" + model_name)
