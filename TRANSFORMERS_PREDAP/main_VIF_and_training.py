...
from src.utils.experiments_utils import (
    get_codes_list, smart_read, safe_float, initialize_results_tracking, 
...
def main_experiment(cfg: DictConfig) -> None:
    ...
    diagnostic_covariates_path = default_config.diagnostic_covariates_path
    best_code_name = diagnostic_covariates_path + CODE + '.xlsx'
    ...
    if not os.path.exists(best_code_name):
        ...
        CCLR_pipeline(
            ...
            CODES_LIST=[CODE],
            BEST_FEATURES_PATH = default_config.diagnostic_covariates_path,
        )
